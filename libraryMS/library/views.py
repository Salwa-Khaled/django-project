...
def index(request):         ### Function View of home page
    if request.method == 'POST':
        add_book = BookForm(request.POST, request.FILES)
        if add_book.is_valid():
            add_book.save()
        add_cate = CateForm(request.POST)
...
def update(request,id):      ### Function View of update page
...
def delete(request,id):      ### Function View of delete page
